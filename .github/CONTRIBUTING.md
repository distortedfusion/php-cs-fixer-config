...
All contributions are **welcome**, [all contributors](https://github.com/distortedfusion/php-cs-fixer-config/graphs/contributors) will be fully **credited**.

## Bug Report

We accept bug reports via issues created on [Github](https://github.com/distortedfusion/php-cs-fixer-config/issues).
...
- **Always try the [master branch](https://github.com/distortedfusion/php-cs-fixer-config)** - It's possible a reported bug is fixed but, hasn't been tagged yet.
...
We accept contributions via Pull Requests on [Github](https://github.com/distortedfusion/php-cs-fixer-config/pull).
